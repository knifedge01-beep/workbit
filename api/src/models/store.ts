...
function normalize(store: Partial<Store>): Store {
  return {
    ...
    statusUpdateComments: store.statusUpdateComments ?? EMPTY_STORE.statusUpdateComments,
    projectPropertiesByTeam: store.projectPropertiesByTeam ?? EMPTY_STORE.projectPropertiesByTeam,
